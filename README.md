...
launchd starts jobs from a clean environment, so the installer resolves `claude`
and a usable `python3` up front and bakes their directories into the installed
plist. See `launchd/README.md`.
